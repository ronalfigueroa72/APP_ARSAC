...
import 'edita_informacion_model.dart';
export 'edita_informacion_model.dart';

class EditaInformacionWidget extends StatefulWidget {
  const EditaInformacionWidget({super.key});

  @override
  State<EditaInformacionWidget> createState() => _EditaInformacionWidgetState();
}

class _EditaInformacionWidgetState extends State<EditaInformacionWidget>
    with TickerProviderStateMixin {
  late EditaInformacionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditaInformacionModel());
