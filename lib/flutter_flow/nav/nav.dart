...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'ReportePorAsitencia',
          path: '/reportePorAsitencia',
          builder: (context, params) => const ReportePorAsitenciaWidget(),
        ),
        FFRoute(
          name: 'Profile',
          path: '/profile',
        ...
        FFRoute(
          ...
          builder: (context, params) => const CarnetAsistenciaWidget(),
        ),
        FFRoute(
